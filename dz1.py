class Person:
    ...
    def introduce_myself(self):
        ...
        print(f'Имя:{self.ful_name}',f'Возраст:{self.age},'f'Семейное положение:{marital_status}')

class Student(Person):
    def __init__(self,ful_name,age, is_married,marks):
        super().__init__(ful_name,age, is_married)
        self.marks = marks
...
def create_students():
        ...
        return  [student1,student3,student2]
